...
# Source files
SRCS= main.c component.c window.c button.c loops.c event.c renderer.c glew.c images_diffuse.c vector.c entity.c rdtest.c tiles.c screenshot.c particle.c towers.c projectile.c spider.c snake.c bat.c health.c tools.c wave.c
